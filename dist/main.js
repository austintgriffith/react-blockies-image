...
var Identicon = function (_Component) {
  ...
  _createClass(Identicon, [{
    ...
    value: function generateIdenticon(options) {
      ...
      function createImageData(size,reflect) {
      ...
      function setCanvasFrame(identicon, imageData, color, size, border, bgcolor, spotcolor) {
        var width = Math.sqrt(imageData.length);
      ...
      var canvas
      if(opts.border) canvas = setCanvasFrame(this.identicon, createImageData(size/border), color, size, border, bgcolor, spotcolor);
      else  canvas = setCanvas(this.identicon, createImageData(size,true), color, scale, bgcolor, spotcolor);
      ...
      if(this.props.border){
        return _react2.default.createElement('div', {style:{
          ...
          _react2.default.createElement('div', {style:{
            ...
            top:this.props.border,
          }},_react2.default.createElement('img',{src:this.props.image,style:{
            width:this.props.size-(this.props.border*2),
            height:this.props.size-(this.props.border*2)
          }}))
        );
